...
public class WorkQueueMonitorTest
{
  ...
  public void MonitorDequeuesAssignsWorkToProcessor() {
    ...
    //Start a thread to pull off the data and call a FixtureActionProcessor to pass the data onto a resourceImpl and run it.
    ...
    /*Now check that the FixtureActionProcessor pulled off this resource's implementation to process the data, this is a slight bit of integration testing
     * WorkQueueMonitor calls FixtureActionProcessor which in turn calls the resource.  As we can't directly look in FixtureAction action processor without

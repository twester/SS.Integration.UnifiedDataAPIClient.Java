...
public class JsonHelperTest {
	...
	public void testToRestItems() {
		...
		assertEquals(
				"http://xxx.test123url.com/UnifiedDataAPI/snapshot/Football/testresource2/eW-m1htDbDHblJ3hBGH8G-PJYvsy",
				href);
	}
	...
	public void testToJson() {
		...
		assertEquals(
				"{\"host\":\"TEST_HOST\",\"queue\":\"QUEUE\",\"message\":\"a78c6f2c-92f4-44bb-b7c9-69cd7b59ee1a;"
						+ df.format(new Date(6256132)) + "\"}",
				stringStreamEcho);
	}
